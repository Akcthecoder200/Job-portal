import { createJob, getJobs, getJobsByLocation, getJobsBySkill, getJobsByTags, getUserPosts } from "../controllers/jobController.js";
...
jobRouter.get('/my-posts', authUser, getUserPosts);
