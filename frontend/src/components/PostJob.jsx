...
import { Plus, X, DollarSign, MapPin, FileText, Tag, Briefcase, ArrowRight, Wallet, Loader, CheckCircle, ExternalLink, AlertCircle } from 'lucide-react';
...
//     try {
//       const token = localStorage.getItem('jwtToken');
//       const response = await fetch(`${API_BASE_URL}/payments/log-payment`, {
//         method: 'POST',
//         headers: {
      ...
      <div className="mb-8">
        <div className="flex items-center justify-center space-x-8">
          <div className={`flex items-center ${currentStep >= 1 ? 'text-blue-600' : 'text-gray-400'}`}>
            <div className={`w-8 h-8 rounded-full flex items-center justify-center ${paymentCompleted ? 'bg-green-600 text-white' : currentStep >= 1 ? 'bg-blue-600 text-white' : 'bg-gray-300 text-gray-600'}`}>
      ...
      {currentStep === 1 && (
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6">
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800">Platform Fee Payment</h2>
            <p className="text-gray-600 mt-2">Pay the platform fee to post your job</p>
            <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-md">
              <p className="text-sm text-yellow-800">
                <strong>Per-Post Fee:</strong> You need to pay for each job you post
              </p>
            </div>
          </div>
          ...
          {!walletConnected ? (
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-700 mb-3">Choose Your Wallet</h3>
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-gray-600">Ethereum - {PLATFORM_FEES.ethereum} ETH per post</div>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="text-sm text-gray-600">
                  ...
                  <div className="mt-1">Balance: {balance} {walletType === 'ethereum' ? 'ETH' : 'SOL'}</div>
                </div>
              </div>
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-lg font-semibold text-gray-800">Platform Fee</span>
                  <div className="flex items-center gap-1">
                    <DollarSign className="w-5 h-5 text-green-600" />
                    <span className="text-lg font-bold text-green-600">
                      {walletType === 'ethereum' ? PLATFORM_FEES.ethereum : PLATFORM_FEES.solana}{' '}
                ...
                {paymentStatus === 'processing' && (
                  <div className="text-center py-4">
                    ...
                    <p className="text-sm text-gray-500 mt-1">Please confirm the transaction in your wallet</p>
                  </div>
                )}
                ...
                {paymentStatus === 'success' && (
                  <div className="text-center py-4">
                    ...
                    <p className="text-sm text-gray-600 mb-4">You can now post your job</p>
                    {transactionHash && (
                      <a
                        href={`${walletType === 'ethereum' ? 'https://etherscan.io' : 'https://explorer.solana.com'}/tx/${transactionHash}`}
                        target="_blank"
                ...
                {paymentStatus === 'error' && (
                  <div className="text-center py-4">
                    ...
                    <p className="text-red-600 font-semibold mb-2">Payment Failed</p>
                    <button
            ...
            <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-md">
              <div className="flex items-center gap-2">
                ...
                <span className="text-green-700 text-sm">
                  Payment confirmed: {paymentDetails?.amount} {paymentDetails?.currency}
                </span>
              </div>
            </div>
          </div>
