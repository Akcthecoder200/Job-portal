...
import { Search, MapPin, Tag, Code, DollarSign, User, Calendar, Filter, X } from 'lucide-react';
  ...
  const fetchJobs = async (type = 'all', value = '') => {
    ...
    try {
      ...
      if (type === 'skill' && value) {
        ...
        url = `${API_BASE_URL}/get-jobs-by-location/${encodeURIComponent(value)}`;
        ...
        {filterValue && (
          <div className="mt-4 flex items-center gap-2">
            ...
            <span className="text-sm text-gray-600">
              Filtered by {filterType}: <span className="font-medium">{filterValue}</span>
            </span>
            <button
